...
## Tema
### Descripción
Sistema CRM para la gestión de clientes, productos y pedidos, orientado a la optimización de ventas . Permite gestionar usuarios, productos, realizar pedidos y consultar el historial de ventas. Con enfoque en una experiencia de usuario sencilla .
...
| **Epic 2: Gestión de Productos **  | Este epic se enfoca en la gestión de productos. A medida que los productos son vendidos a través de los pedidos <br> **Flujo**: Un administrador gestiona el catálogo de **Productos**: agregar, editar o eliminar productos. <br> **Relación con otros epics**: **Productos** afecta a **Pedidos**.  |
